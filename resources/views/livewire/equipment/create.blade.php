                    ...
                    <div class="">
                        ...
                        <div class="mb-4">
                            ...
                            px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    id="equipmentType" placeholder="Select Equipment Type"
                                    wire:model="equipment_type_id">
                            ...
                            @error('equipment_type_id') <span class="text-red-500">
                                {{ $message }}
                            </span>@enderror
                        </div>
                    </div>
